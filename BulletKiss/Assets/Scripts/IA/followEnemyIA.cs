...
public class followEnemyIA : MonoBehaviour
{
    ...
    void Update()
    {
        if (player != null) 
        {
            ...
            ///es mayor al radio de detecci�n que tiene el enemigo y ademas el no agente tiene una ruta pendiente
            ///y adem�s de la ruta pendiente le faltan 0.5cm para llegar a su destino entonces calcule una ruta al azar
            ///SUMARY
